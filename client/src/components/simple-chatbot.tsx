...
export function SimpleChatbot({ businessSlug, businessData }: SimpleChatbotProps) {
  ...
  const processMessage = (message: string): string => {
    ...
    if (lowerMessage.includes('business name') || 
    ...
    if (lowerMessage.includes('open now') || 
    ...
    if (serviceMatch && (lowerMessage.includes('cost') || 
    ...
    if (serviceMatch && (lowerMessage.includes('long') || 

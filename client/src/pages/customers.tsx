...
export default function Customers() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-intelliserve-secondary mb-2">Customers</h1>
          <p className="text-gray-600">Manage your customer base and contact information</p>
        </div>

...
export default function Landing() {
  ...
  const features = [
    {
      ...
      description: "Smart chatbot automation that handles customer inquiries and bookings 24/7",
      gradient: "from-purple-600 to-indigo-600"
    },
    {
      icon: Calendar,
      title: "Smart Scheduling",
      description: "Automated appointment booking with conflict detection and optimal time suggestions",
      gradient: "from-emerald-500 to-teal-600"
    },
    {
      icon: Users,
      title: "Customer Management",
      description: "Complete customer profiles with history, preferences, and automated follow-ups",
      gradient: "from-cyan-500 to-blue-600"
    },
    {
      icon: BarChart3,
      title: "Analytics Dashboard",
      description: "Real-time business insights with revenue tracking and performance metrics",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button onClick={() => scrollToSection('features')} className="text-purple-200 hover:text-white transition-colors">
                Features
              </button>
              <button onClick={() => scrollToSection('pricing')} className="text-purple-200 hover:text-white transition-colors">
                Pricing
              </button>
              <button onClick={() => scrollToSection('contact')} className="text-purple-200 hover:text-white transition-colors">
                Contact
              </button>
              <Button 
          ...
          {showMobileMenu && (
            <div className="md:hidden pb-6 space-y-4">
              <Button variant="ghost" className="w-full justify-start text-purple-200" onClick={() => scrollToSection('features')}>
                Features
              </Button>
              <Button variant="ghost" className="w-full justify-start text-purple-200" onClick={() => scrollToSection('contact')}>
                Contact
              </Button>
              <Button onClick={() => setShowLogin(true)} className="w-full">
                Sign In
              </Button>
              <Button onClick={() => setShowRegister(true)} className="w-full btn-gradient">
                Get Started
              </Button>
            </div>
          )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-lg rounded-full px-6 py-3 border border-white/20">
              ...
              <span className="text-sm font-medium">Revolutionary CRM Technology</span>
            </div>
            ...
            <p className="text-xl lg:text-2xl text-purple-200 max-w-4xl mx-auto leading-relaxed">
              IntelliServe revolutionizes how service businesses operate with intelligent automation, 
              seamless customer management, and data-driven insights that boost revenue by up to 40%.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 pt-8">
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="text-lg px-12 py-4 rounded-2xl border-white/30 text-white hover:bg-white/10 backdrop-blur-lg"
              >
      ...
      {/* Features Section */}
      <section id="features" className="relative z-10 py-20 bg-black/20 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-purple-200 max-w-3xl mx-auto">
              Everything you need to streamline operations, delight customers, and scale your business.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <Card key={index} className="modern-card group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 border-0 bg-white/5 backdrop-blur-lg">
                  <CardHeader className="text-center pb-4">
                    <div className={`w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
                      <Icon className="w-8 h-8 text-white" />
                    </div>
                    <CardTitle className="text-xl font-bold text-white">{feature.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-purple-200 text-center leading-relaxed">{feature.description}</p>
                  </CardContent>
                </Card>
              );
            })}
      ...
      <section id="contact" className="relative z-10 py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-purple-200">Get in touch and let's discuss your success story.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-purple-600/20 to-cyan-600/20 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                <p className="text-white font-medium mb-2">About the Developer</p>
                <p className="text-purple-200 text-sm leading-relaxed">
                  "I designed, developed and deployed this CRM app — solo, like a one-man army."
                </p>
                <p className="text-cyan-400 text-sm mt-2 font-medium">- Zaid Naeem</p>
              </div>
            </div>
                ...
                <form onSubmit={handleContactSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-white/10 border border-white/30 rounded-xl text-white placeholder-purple-300 focus:ring-2 focus:ring-cyan-400 focus:border-transparent resize-none"
                      required
                    />
                  </div>

        ...
        <div className="px-8 pb-4">
          <div className="relative max-w-md">
            ...
            <Input
              ...
              className="pl-10 bg-white/10 border-white/30 text-white placeholder-white/70 focus:border-cyan-400 rounded-xl"
            />
          </div>
        </div>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4 mb-4">
                      <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-cyan-500 rounded-2xl flex items-center justify-center text-white font-bold text-xl group-hover:scale-110 transition-transform">
                    ...
                    <div className="space-y-3 mb-4">
                      {customer.email && (
                        <div className="flex items-center space-x-3 text-sm text-white bg-white/5 rounded-xl p-3">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="bg-white/5 rounded-xl p-3 text-center">
                        <div className="flex items-center justify-center space-x-1 mb-1">
                          ...
                          <span className="text-xs text-white">Last Visit</span>
                        </div>
